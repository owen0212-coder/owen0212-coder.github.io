...
export function createWorld(container){
 ...
 // Faceted fish with moving fins and tails, safely beneath the surface.
 const swimmers=[];for(let i=0;i<10;i++){const g=createSwimmingFish(i);scene.add(g);swimmers.push(g);}
 ...
 for(const fish of swimmers)animateSwimmingFish(fish,t,reduced);
